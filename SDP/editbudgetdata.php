...
if (isset($_POST['send'])) {
    ...
    $updateQuery = "UPDATE tblsetting SET category='$category', amount='$amount' WHERE id= '$myIDS'";
...
<head>
    ...
    <title>Edit Budget Setting</title>
...
<body>
    <div class="heading">
        <h3>Edit Budget</h3>
        <p> <a href="userhome.php?myID=<?php echo $_SESSION['myID']; ?>">Home</a> / <a href="budget.php?myID=<?php echo $_SESSION['myID']; ?>">Budget Setting</a> / Edit Budget</p>
    </div>
    <div class="contact">
