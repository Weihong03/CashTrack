...
<body>
    <div class="heading">
        <h3>Calculator</h3>
        <p> <a href="userhome.php?myID=<?php echo $_SESSION['myID']; ?>">Home</a> / Calculator </p>
    </div>
    <div style="animation: openAccount 0.5s ease forwards;padding: 100px">
        <form class="abc">
            <div id="digit1">
                                    ...
                                    <div id="digit7">
                                        ...
                                        <div id="digit8">
                                            ...
                                            <div id="operations">
                                                ...
                                                <main style="border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);">
                                                    <div id="screen">
                                                        <div id="input"></div>
                                                        <div id="output" height: 150px; line-height: 100px; padding: 0 36px; font-size: 80px;></div>
                                                    </div>
                                                    <div id="buttons">
                                                        <button type="button">
