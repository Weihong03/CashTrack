...
if (isset($_POST['send'])) {
    ...
    '$title','$amount','$account','$category','Income', '$date')";
    ...
    if (mysqli_multi_query($connection, $querys)) {
        echo 'Income successfully created!';
...
<body>
    <div class="heading">
        <h3>Add Income</h3>
        <p> <a href="userhome.php?myID=<?php echo $_SESSION['myID']; ?>">Home</a> / <a href="income.php?myID=<?php echo $_SESSION['myID']; ?>">Income Management</a> / Add Income</p>
    </div>
    <div class="contact">
